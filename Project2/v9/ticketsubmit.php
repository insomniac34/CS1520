  ...
  <body data-ng-app="SupportTicketSubmission">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="ticketsubmit.php">Ticket</a></li>
    ...
    <div class="jumbotron" ng-controller="TicketSubmissionController">
      <div class="container">
        ...
        <p>Please be sure to fill out all fields. </p>
        <form name="ticketSubmit" class="css-form" novalidate>
          <label>First Name&nbsp</label> <input type="text" ng-model="ticket.firstName" required /><br/>
          <label>Last Name&nbsp</label> <input type="text" ng-model="ticket.lastName" required /><br/>
          <label>Email&nbsp</label> <input type="email" ng-model="ticket.email" required /><br />
          <label>Problem&nbsp</label> <input type="text" ng-model="ticket.problem" required/><br>

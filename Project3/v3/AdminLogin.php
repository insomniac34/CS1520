<?php
  ...
  if (isset($_SESSION["user"]))
  {
    ...
    else if (strcmp($_SESSION["user"], "user")==0)
    {
  ...
  <body data-ng-app="AdminPortalLogin">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <?php 
                ...
                if (!isset($_SESSION['user'])) echo '<li class="active"><a href="AdminLogin.php">Admin</a></li>';
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <label> </label><li><a href="#" data-toggle="modal" data-target="#reminderModal">Forgot your password?</a></li>
      </div>
    </div>

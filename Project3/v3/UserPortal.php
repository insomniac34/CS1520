<?php
  ...
  {
    $log->info("Resuming USER session: ".$_SESSION['user']);
  }
  ...
  if (!isset($_SESSION['user'])) //if someone isnt already logged in, then a new user is logging in.
  {
    ...
    $userVerificationQuery = "SELECT * FROM `all_portal_users` WHERE `name`=\"".$username."\" AND `role`=\"user\"";
  ...
  if ((isset($_SESSION["user"]) && strcmp($userRole, "user") == 0) || (!empty($_POST['username'])) && strcmp($resultArray['name'], "$username") == 0 && strcmp($resultArray['password'], md5($attemptedPassword)) == 0) //IF either the session is ongoing OR a succesful login attempt has occured, display portal page.
  {
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">OpenTech User Portal</a>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav navbar-right">
                ...
                <?php 
                    ...
                    {
                      echo '<li class="active"><a href="UserPortal.php">User Portal</a></li>';
          ...
          <div class="row">
            ...
            <div class="col-sm-3 col-md-2 sidebar" ng-controller="AdminPortalSidebarController">
              <ul class="nav nav-sidebar">
                ...
                <li><a href="#" onclick="viewMyTickets('2')">View My Unassigned Tickets</a></li> <!-- data-ng-click="viewUnassignedTickets()" -->
                <li><a href="#">Export</a></li>
              </ul>
              <ul class="nav nav-sidebar">
                <!-- <li><a href="" onclick="viewMyTickets('1')">View All Tickets</a></li> --> <!-- data-ng-click="viewAllTickets()" --> 
                <li><a href="" onclick="viewMyTickets('0')">View My Submitted Tickets</a></li> <!-- data-ng-click="viewMyTickets()" -->
                <li><a href="">Sort</a></li>
              </ul>
            </div>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              <h1 class="page-header">OpenTech User Information Center</h1>
  
              <div class="row placeholders">

              <div class="jumbotron text-left" ng-controller="TicketSubmissionController">
                <div class="container">
                  <?php
                    /*
                  ...
                  <form name="ticketSubmit" class="css-form" novalidate>
                    <h1>Submit a New Ticket</h1><br>
                    <!-- <input style="margin:0 0 5px 0;" type="text" class="form-control" placeholder="First Name" name="firstName" ng-model="ticket.firstName" required /><br/> -->
                    <!-- <input style="margin:0 0 5px 0;" type="text" class="form-control" placeholder="Last Name" name="lastName" ng-model="ticket.lastName" required /><br/> -->
                    <input style="margin:0 0 5px 0;" type="email" class="form-control" placeholder="Email" name="email" ng-model="ticket.email" required /><br />
                    <input style="margin:0 0 5px 0;" type="text" class="form-control" placeholder="Problem Description" name="problem" ng-model="ticket.problem" required/><br>
                    <button style="margin:0 0 5px 0;" class="btn btn-primary" ng-click="reset()" ng-disabled="isUnchanged(ticket)">Clear</button> 
                    <!--<input type="submit" value="Submit Ticket" ng-click="submit(ticket)" ng-disabled="ticketSubmit.$invalid || isUnchanged(ticket)"> -->
                    <button style="margin:0 0 5px 0;" class="btn btn-primary" ng-click="submit(ticket)" ng-disabled="ticketSubmit.$invalid || isUnchanged(ticket)">Submit Ticket</button>
              ...
              <h2 class="sub-header">My Tickets (Currently Selected: Ticket <span ticket-number-directive="ticket_id"></span>)</h2>
                    ...
                    <div class="modal-dialog" style="height: 685px;">
                        <div class="modal-content" ng-controller="AdminPortalTicketDetailsController" style="height: 685px;">
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                <label><b>Send Email to Admin</b></label>
                ...
                <table class="table table-hover" id="theTable">
                  ...
                  <tbody>
                    ...
                    */
                        ...
                        $result = $db->query("SELECT * FROM `tickets` WHERE `name`=\"".$_SESSION['user']."\"");
 ...
 <script>
          ...
          */
          function viewMyTickets(action) {
            ...
            console.log("Hello from the UserPortal version of viewMyTickets!");
            ...
            switch(action)
            {
              case '0':
                ...
                xmlhttp.send(JSON.stringify({action: "viewUsersTickets"}));
                break;
              ...
              case '2':
                ...
                xmlhttp.send(JSON.stringify({action: "viewUsersUnassignedTickets"}));
                break;
          ...
          function sortTable(sortBy)
          {
            ...
            //create data rows
            var initialRadioButton = 0;
            for (i = 0; i < keyArray.length; i++)
            {
              if (i==0) 
              {
                initialRadioButton = keyArray[i].id;
              }
            ...
            for (i = 0; i < len; i++)
            {
              ...
              transmitRadioStatusToAngular(initialRadioButton); //set initially selected radio button value
          }
          ...
          */
          ...
          function destroyTable() //destroys table and re-adds head
          {
            //destroy table rows AFTER table head
            var numRows = document.getElementById("theTable").rows.length;
            for (var j = 0; j < numRows; j++) {
              document.getElementById("theTable").deleteRow(0);
            }       
          ...
          function updateTableAfterSubmit(theId, theDate, theName, theEmail, theSubject, theTech, theStatus)
          {
            console.log("Hello from updateTableAfterSubmit!");
